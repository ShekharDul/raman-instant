...
<body>
    <div class="container">
        ...
        <section class="bibliography-section">
            ...
            <div class="bib-item">[3] Instant Raman Documentation. "Uncertainty Quantification and Epistemic Risk in Peak Fitting." https://shekhardul.github.io/raman-instant/docs</div>
        </section>

        <footer>
            <a href="https://shekhardul.github.io/raman-instant/" class="branding-link">
